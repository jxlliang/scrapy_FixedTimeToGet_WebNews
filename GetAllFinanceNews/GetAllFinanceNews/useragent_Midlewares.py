...
class UserAgent(UserAgentMiddleware):
    ...
    def process_request(self, request, spider):
        user_A=random.choice(self.userAgentList)
        if user_A:#显示当前使用的userAgent
            log.msg('Current UserAgent:'+user_A,_level=logging.INFO)
            request.headers.setdefault('User-Agent',user_A)
    userAgentList=["Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 "
